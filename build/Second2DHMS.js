...
var TimeClass = Class.create({
    initialize: function(selector) {
      ...
      this.timeObj = $(selector);
    },
    Second2DHMS: function(num) {
        var s = num%60;
        num=parseInt(num/60);
        var m = num%60;
        num = parseInt(num/60);
...
var TimeScalarClass = Class.create(TimeClass, {
    initialize: function($super, selector, range) {
        ...
        function InitHourChangeEvent(){
            ...
            timeObj.on("change", "#Hour", function(event){
                ...
                /* 时值 最大和最小 都是一个值
                    ...
                    49710天6时28分14秒
                 */
                if ( (dayObj.data("cursor") === "MinMax") && (minHour === maxHour) )
                {
        ...
        function InitMinuteChangeEvent(){
